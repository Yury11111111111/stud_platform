      ...
      <Content className="account-content">
        <div className="content__top">
          ...
          <div className="content__top__info">
            ...
            <p className="content__top__info-strikes">
              Количество страйков: {student.strikes}
            </p>
          </div>
        </div>
        <div className="content__bottom">
          ...
          <div className="content__bottom-weekday">
            {weekNumbers.map((date, index) => (
              <div
                key={index}
                className="content__bottom-weekday-day"
                style={
                  currentDay === index
                    ? currentDayStyle
          ...
          <div className="content__bottom-events">
            {eventsToday.map((event) => (
              <div
                className={`content__bottom-events-event ${getRandomStyle()}`}
              >
